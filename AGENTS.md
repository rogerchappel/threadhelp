# Agent Operating Instructions for threadhelp

This file defines how AI agents and human maintainers should work in `threadhelp`.

## Project Context

- Project: `threadhelp`
- Repository: `https://github.com/rogerchappel/threadhelp`
